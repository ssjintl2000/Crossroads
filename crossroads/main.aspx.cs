    ...
    public partial class main : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (var song in songs)
            {
                ...
                {
                    sbsongs.Append("<a href=Javascript:winOpen('/content/songs/mp3s/" + songdetails.MP3 + "','MP3',300,150,0,0,0)>Play</a>");
                }
                ...
                {
                    sbsongs.Append("<a href=Javascript:winOpen('/content/songs/pdfs/" + songdetails.PDF + "','PDF',800,600,1,1,1)>View</a>");
                }
                ...
                {
                    sbsongs.Append("<a href=Javascript:winOpen('/content/songs/tracks/" + songdetails.Track + "','TRACK',400,150,0,0,0)>Play</a>");
                }
